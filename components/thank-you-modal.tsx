  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold mb-4 text-center">Thank You!</DialogTitle>
        </DialogHeader>
        <div className="text-center">
          <p className="text-lg font-bold mb-4">Welcome to the Cattler Community!</p>
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="flex items-center mb-2">
              ...
              <a href="tel:+15312345882" className="font-bold">
                +1 (531) 234-5882
              </a>
            </div>
            <div className="flex items-center">
              ...
              <a href="mailto:info@cattler.farm" className="font-bold">
                info@cattler.farm
              </a>
            </div>
          </div>
          ...
          <Button
            asChild
            className="bg-[#22CE88] text-white font-bold py-2 px-4 rounded-full inline-flex items-center mb-6"
          >
          ...
          <h3 className="text-xl font-bold mb-4">Download Cattler App</h3>
          ...
          <div className="flex justify-center space-x-4">
            <Image
              src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://play.google.com/store/apps/details?id=com.cattlerapp&hl=en_US&pli=1"
            ...
            />
            <Image
              src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://apps.apple.com/us/app/cattler/id1584969241"
