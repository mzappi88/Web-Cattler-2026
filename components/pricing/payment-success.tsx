...
export default function PaymentSuccess({
  ...
  const handleContactSupport = () => {
    window.open(
      "mailto:suporte@cattler.com?subject=Nova Assinatura - Suporte",
      "_blank"
    );
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="bg-white border border-cattler-green/30">
                <CardHeader>
                  ...
                  <CardDescription className="font-roboto text-cattler-navy/70">
                    Tudo está configurado! Aqui está o que você pode fazer
                    agora:
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-roboto text-cattler-navy/70">
                        Clique no botão abaixo para acessar o sistema FEEDER e
                        começar a gerenciar seu confinamento.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-roboto text-cattler-navy/70">
                        Use o assistente de configuração para adicionar seus
                        currais, dietas e animais.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-roboto text-cattler-navy/70">
                        Descubra todas as funcionalidades do seu plano e como
                        elas podem otimizar sua operação.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-blue-50 border border-blue-200">
                <CardHeader>
                  <CardTitle className="text-lg font-barlow text-blue-900">
                    Precisa de Ajuda?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm font-roboto text-blue-800 mb-4">
                    Nossa equipe de suporte está pronta para ajudar você a
                    começar. Entre em contato conosco se tiver alguma dúvida.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        window.open("https://help.cattler.com", "_blank")
                      }
