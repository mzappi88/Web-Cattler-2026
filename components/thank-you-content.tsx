...
const ThankYouContent: React.FC = () => {
  return (
    <div className="w-full max-w-2xl mx-auto text-center p-8 rounded-lg bg-white shadow-lg">
      <h1 className="text-3xl font-bold mb-6 text-primary">Thank You!</h1>
      ...
      <div className="flex flex-col items-center mb-6">
        <div className="flex items-center mb-2">
          ...
          <a href="tel:+15312345882" className="font-bold text-primary">
            +1 (531) 234-5882
          </a>
        </div>
        <div className="flex items-center">
          ...
          <a href="mailto:sales@cattler.farm" className="font-bold text-primary">
            info@cattler.farm
          </a>
        </div>
      </div>
