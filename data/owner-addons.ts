...
const ADDON_CONFIGS_BY_COUNTRY: Record<string, Record<string, {
  ...
  US: {
   ...
   "MicroMachineIntegration": {
    ...
    "pastureManagementBasic": {
      ...
      description: "pasture management system",
      availableFor: ["plan1", "plan2", "plan3", "plan4"],
      includedIn: [],
      comingSoon: true,
      hidden: false,
    ...
    "cowCalfBasic": {
      name: "Cow-Calf",
      description: "Cow-calf management system",
      availableFor: ["plan1", "plan2", "plan3", "plan4"],
      includedIn: [],
      comingSoon: true,
      hidden: false,
  ...
  CA:  {
    "customFeeder": {
      name: "Custom Feeder Module",
      description: "Complete management for custom feeding operations with multiple clients.\n\nIncludes:\n• Admin & Account Management\n• Grain Bank\n• Market Value & Margin & Profits Report\n• 2 users for each client profile",
      availableFor: ["plan1", "plan2", "plan3", "plan4"],
      includedIn: [],
      isCustomFeeder: true,
      hidden: false,
