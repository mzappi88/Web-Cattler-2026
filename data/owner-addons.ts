...
const ADDON_CONFIGS_BY_COUNTRY: Record<string, Record<string, {
  ...
  AR: {
    ...
    "animalHealth": {
      name: "Sanidad Animal",
      description: "Registra tratamientos y diagnósticos, permite apartar animales enfermos y gestionar el manejo individual. Lleva inventario de insumos veterinarios, aplica costos y mantiene la trazabilidad sanitaria del establecimiento.",
      availableFor: ["plan1", "plan2"],
      includedIn: ["plan3", "plan4"],
      hidden: false,
    },
    "chute": {
      name: "Manga",
      description: "Registra pesos, asigna caravanas y aparta animales, integrado con lectores de caravana electrónica. Para aplicar tratamientos sanitarios se requiere el módulo de Sanidad Animal.",
      availableFor: ["plan1"],
      includedIn: ["plan2", "plan3", "plan4"],
      hidden: false,
    },
    ...
    "pastureManagementBasic": {
      ...
      description: "Sistema de gestión de pastura",
      availableFor: ["plan1", "plan2", "plan3", "plan4"],
      includedIn: [],
      comingSoon: true,
      hidden: false,
    ...
    "cowCalfBasic": {
      name: "Cría y Recría",
      description: "Sistema de gestión cría y recría",
      availableFor: ["plan1", "plan2", "plan3", "plan4"],
      includedIn: [],
      comingSoon: true,
      hidden: false,
    ...
    "feedingProtocols": {
      name: "Programación de Plan de Alimentación por Lote",
      description: "Define el plan de alimentación completo de cada lote y genera de forma automática las órdenes de entrega según las dietas y cantidades planificadas.",
      availableFor: ["plan1", "plan2"],
      includedIn: ["plan3", "plan4"],
      hidden: false,
    },
    ...
    "advancedInventory": {
      ...
      description: "Sistema avanzado de gestión de inventario. Incluye compras y transformaciones de ingredientes y gestión de premezclas.",
      availableFor: ["plan2", "plan3"],
      includedIn: ["plan3", "plan4"],      
      hidden: false,
    },
...
"autoAdjust": {
    ...
    "cuota481": {
      name: "Informe Cuota 481",
      description: "Informe especializado para cumplimiento de cuota 481",
      availableFor: ["plan1", "plan2", "plan3", "plan4"],
      includedIn: [],
      hidden: true,
    },
  ...
  CH: {
    ...
    "animalHealth": {
      name: "Sanidad Animal",
      description: "Gestión completa de la sanidad del feedlot",
      availableFor: ["plan1"],
      includedIn: ["plan2", "plan3", "plan4"],
      hidden: false,
    },
    "chute": {
      name: "Manga Completa",
      description: "Sistema completo de manejo en manga. Incluye planificación de tratamientos y manga para el ingreso de animales.",
      availableFor: ["plan1", "plan2"],
      includedIn: ["plan3", "plan4"],
      hidden: false,
    },
  ...
  UY: {
    ...
    "chute": {
      name: "Manga",
      description: "Sistema completo de manejo en manga y lector de caravanas electrónicas",
      availableFor: ["plan1"],
